...
EntityBase::EntityBase(void):m_x(0.0),m_y(0.0),m_CurrentSprID(0),m_fWidth(0.0),m_fHeight(0.0),m_nLife(1),m_sprDebug(NULL),m_nEntityStat(ENUM_ENTITY_NORMAL),m_fDesotryTime(0.3)
{
