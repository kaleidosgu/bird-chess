...
SoundSystem::SoundSystem(void):m_pBg(NULL)
{
	...
	m_mapSound[1] = m_pHge->Effect_Load("Res/GameSound/BirdDead0.wav");
	m_mapSound[2] = m_pHge->Effect_Load("Res/GameSound/BirdDead1.wav");
	m_mapSound[3] =	m_pHge->Effect_Load("Res/GameSound/BirdDead2.wav");
	m_mapSound[4] = m_pHge->Effect_Load("Res/GameSound/BirdDead3.wav");
	m_mapSound[5] = m_pHge->Effect_Load("Res/GameSound/BirdDead4.wav");
	m_mapSound[6] = m_pHge->Effect_Load("Res/GameSound/BirdDead5.wav");
	m_mapSound[7] = m_pHge->Effect_Load("Res/GameSound/BirdDead6.wav");
