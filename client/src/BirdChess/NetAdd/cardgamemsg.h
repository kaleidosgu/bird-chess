...
enum
{
	...
	MSGID_CARDGAME_S2C_UseCardResult,
...
struct MSG_CARDGAME_S2C_UseCardResult : public MSG_BASE
{
	MSG_CARDGAME_S2C_UseCardResult()
	{
		nMsg = MSGID_CARDGAME_S2C_UseCardResult;
		nSize = sizeof(MSG_CARDGAME_S2C_UseCardResult);
		nResult = 0;
	}
	int nResult;
};
